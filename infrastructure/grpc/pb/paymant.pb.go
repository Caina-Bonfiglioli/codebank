...
// 	protoc        v3.6.1
// source: protofile/paymant.proto
...
var File_protofile_paymant_proto protoreflect.FileDescriptor
...
var (
	file_protofile_paymant_proto_rawDescOnce sync.Once
	file_protofile_paymant_proto_rawDescData = file_protofile_paymant_proto_rawDesc
)

func file_protofile_paymant_proto_rawDescGZIP() []byte {
	file_protofile_paymant_proto_rawDescOnce.Do(func() {
		file_protofile_paymant_proto_rawDescData = protoimpl.X.CompressGZIP(file_protofile_paymant_proto_rawDescData)
	})
	return file_protofile_paymant_proto_rawDescData
}
...
func init() { file_protofile_paymant_proto_init() }
func file_protofile_paymant_proto_init() {
	if File_protofile_paymant_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_protofile_paymant_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_protofile_paymant_proto_goTypes,
		DependencyIndexes: file_protofile_paymant_proto_depIdxs,
		MessageInfos:      file_protofile_paymant_proto_msgTypes,
	}.Build()
	File_protofile_paymant_proto = out.File
	file_protofile_paymant_proto_rawDesc = nil
	file_protofile_paymant_proto_goTypes = nil
	file_protofile_paymant_proto_depIdxs = nil
}
